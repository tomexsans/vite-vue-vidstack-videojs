...
function i18n(translations, key) {
  var _a;
  return ((_a = translations()) == null ? void 0 : _a[key]) ?? key;
}
...
function ChapterTitleOrMainTitle() {
  ...
  effect(() => {
    ...
    track && listenEvent(track, "cue-change", () => {
      var _a;
      chapterTitle.set(((_a = track.activeCues[0]) == null ? void 0 : _a.text) || "");
    });
...
// node_modules/vidstack/dist/dev/register.js
function registerAllElements() {
  [Player, Outlet, ...getUIComponents(), CommunitySkin].map(registerLiteCustomElement);
}
export {
  registerAllElements as default
};
//# sourceMappingURL=register-LDBTDSX7.js.map
