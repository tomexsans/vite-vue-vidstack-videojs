...
// node_modules/maverick.js/dist/dev/chunks/chunk-FIEGXSET.js
var SSR_TEMPLATE = Symbol();
...
var END_MARKER = Symbol("END_MARKER");
var END_MARKER_NODE = createComment("/$");
...
function $$_setup_custom_element(host, props) {
  var _a6;
  const Component2 = (_a6 = window[DOM_ELEMENT_REGISTRY]) == null ? void 0 : _a6.get(host.localName);
  if (!Component2) {
    throw Error(
...
var DELEGATED_EVENTS = Symbol("DELEGATED_EVENTS");
var $$_peek = peek;
var $$_scoped = scoped;
var $$_effect = effect2;
...
var ComponentInstance = class {
  constructor(Component2, init = {}) {
    ...
    root((dispose) => {
      ...
      if ((_a6 = init.props) == null ? void 0 : _a6.innerHTML) {
  ...
  _destroy() {
    ...
    (_a6 = this._el) == null ? void 0 : _a6.destroy();
  ...
  if (host.isConnected) {
    ...
    host.attachComponent(
      createComponent(componentCtor, {
        scope: (_a6 = parent == null ? void 0 : parent.component) == null ? void 0 : _a6.instance._scope
      })
    );
  }
}
function resolvePropsFromAttrs(host) {
  ...
  for (const attr of host.attributes) {
    let propName = hostCtor._attrs.get(attr.name), convert = propName && ((_a6 = componentCtor.el.props[propName].type) == null ? void 0 : _a6.from);
    if (convert) {
...
var HTMLCustomElement = class extends HTML_ELEMENT {
  ...
  get $store() {
    var _a6;
    return (_a6 = this._component) == null ? void 0 : _a6.instance._store;
  }
  get state() {
    if (!this._component) {
  ...
  attributeChangedCallback(name, _, newValue) {
    ...
    const from = (_b2 = (_a6 = ctor._component.el.props[propName]) == null ? void 0 : _a6.type) == null ? void 0 : _b2.from;
    if (from)
      this._component.instance._props[propName].set(from(newValue));
  }
  connectedCallback() {
    var _a6;
    const instance = (_a6 = this._component) == null ? void 0 : _a6.instance;
  ...
  disconnectedCallback() {
    ...
    if (instance == null ? void 0 : instance._disconnectCallbacks.length) {
    ...
    if (!this._delegate && !this.keepAlive) {
      requestAnimationFrame(() => {
        if (!this.isConnected) {
          instance == null ? void 0 : instance._destroy();
          this._destroyed = true;
        }
      });
    }
  ...
  attachComponent(component) {
    ...
    scoped(() => {
      ...
      if (def.css && !(init == null ? void 0 : init.adoptCSS)) {
        console.warn(
      ...
      if ((_a6 = this._queuedActions) == null ? void 0 : _a6.size) {
  ...
  subscribe(callback) {
    ...
    if (!((_a6 = this._component) == null ? void 0 : _a6.instance._state)) {
      const ctor = this.constructor;
  ...
  onAttach(callback) {
    if (this._component) {
      ...
      return () => {
        var _a6;
        return (_a6 = this._attachCallbacks) == null ? void 0 : _a6.delete(callback);
      };
    }
  }
  ...
  destroy() {
    ...
    (_a6 = this._component) == null ? void 0 : _a6.destroy();
    this._component = null;
    this._destroyed = true;
  }
  dispatchEvent(event) {
    ...
    if (this._delegate) {
      ...
      if (!ctor._dispatchedEvents.has(event.type)) {
        (_a6 = this._onEventDispatch) == null ? void 0 : _a6.call(this, event.type);
...
function defineElement(declaration) {
  ...
  if ("props" in declaration) {
    ...
    for (const name of Object.keys(props)) {
      const def = ((_a6 = props[name]) == null ? void 0 : _a6[PROP_DEF]) ? props[name] : { [PROP_DEF]: true, value: props[name] };
...
// node_modules/vidstack/dist/dev/providers/type-check.js
...
// node_modules/vidstack/dist/dev/icons/icon.js
var $$_templ = $$_create_template(`<!$><svg viewBox="0 0 32 32" fill="none" aria-hidden="true" focusable="false" data-media-icon="true"></svg>`);
...
// node_modules/vidstack/dist/dev/providers/audio/loader.js
...
var $$_templ2 = $$_create_template(`<!$><audio preload="none" aria-hidden="true"></audio>`);
...
var AudioProviderLoader = class {
  ...
  async load() {
    ...
    return new (await import("./provider-2BPYWLSB.js")).AudioProvider(this._audio);
  }
  render($store) {
    return (() => {
...
// node_modules/vidstack/dist/dev/providers/video/loader.js
var $$_templ3 = $$_create_template(`<!$><video preload="none" aria-hidden="true"></video>`);
...
var VideoProviderLoader = class {
  ...
  async load(context) {
    ...
    return new (await import("./provider-KTKI45QK.js")).VideoProvider(this._video, context);
  }
  render($store) {
...
// node_modules/vidstack/dist/dev/providers/hls/loader.js
var _HLSProviderLoader = class _HLSProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import("./provider-QECFYSWK.js")).HLSProvider(this._video, context);
  }
};
__publicField(_HLSProviderLoader, "supported", isHLSSupported());
var HLSProviderLoader = _HLSProviderLoader;

// node_modules/vidstack/dist/dev/media-core.js
...
var List = class extends EventsTarget {
  ...
  /* @internal */
  [LIST_SET_READONLY](readonly2, trigger) {
    if (this[LIST_READONLY] === readonly2)
      return;
    this[LIST_READONLY] = readonly2;
...
var ScreenOrientationController = class extends ComponentController {
  constructor() {
    super(...arguments);
    __publicField(this, "_type", signal(getScreenOrientation()));
    __publicField(this, "_locked", signal(false));
    __publicField(this, "_currentLock");
  }
  /**
...
var MediaKeyboardController = class extends ComponentController {
  constructor(instance, _media) {
    super(instance);
    __publicField(this, "_seekTotal");
    __publicField(this, "_timeSlider", null);
    this._media = _media;
  }
  onConnect() {
  ...
  _onKeyDown(event) {
    ...
    switch (method2) {
      ...
      case "toggleFullscreen":
        ...
        break;
      default:
        (_b2 = (_a6 = this._media.remote)[method2]) == null ? void 0 : _b2.call(_a6, event);
    }
  }
  ...
  _forwardTimeKeyboardEvent(event) {
    var _a6;
    (_a6 = this._timeSlider) == null ? void 0 : _a6.dispatchEvent(new DOMEvent(event.type, { trigger: event }));
  }
  _seeking(event, type) {
...
var SET_AUTO_QUALITY = Symbol("SET_AUTO_QUALITY");
var ENABLE_AUTO_QUALITY = Symbol("ENABLE_AUTO_QUALITY");
var _a3;
var VideoQualityList = class extends SelectList {
  constructor() {
    super(...arguments);
    __publicField(this, "_auto", false);
    /**
  ...
  /* @internal */
  [(_a3 = ENABLE_AUTO_QUALITY, LIST_ON_USER_SELECT)]() {
...
var MediaEventsLogger = class extends ComponentController {
  ...
  _onMediaEvent(event) {
    var _a6;
    (_a6 = this._media.logger) == null ? void 0 : _a6.infoGroup(`📡 dispatching \`${event.type}\``).labelledLog("Media Store", { ...this.$store }).labelledLog("Event", event).dispatch();
  }
};
var MediaLoadController = class extends ComponentController {
  ...
  async onAttach(el) {
    ...
    if (load === "eager") {
      ...
      const { waitIdlePeriod } = await import("./std-D34UQMQU.js");
...
var MediaPlayerDelegate = class {
  ...
  _dispatch(type, ...init) {
    this._handle(new DOMEvent(type, init == null ? void 0 : init[0]));
  }
  async _ready(info, trigger) {
    ...
    tick();
    {
      logger == null ? void 0 : logger.infoGroup("-~-~-~-~-~-~-~-~- ✅ MEDIA READY -~-~-~-~-~-~-~-~-").labelledLog("Media Store", { ...$store }).labelledLog("Trigger Event", trigger).dispatch();
    }
...
var MediaUserController = class extends ComponentController {
  constructor() {
    super(...arguments);
    __publicField(this, "_idleTimer", -2);
    __publicField(this, "_delay", 2e3);
    __publicField(this, "_pausedTracking", false);
    __publicField(this, "_focusedItem", null);
  }
  /**
  ...
  _onStopIdle(event) {
    ...
    if (isKeyboardEvent(event)) {
      if (event.key === "Escape") {
        ...
        requestAnimationFrame(() => {
          var _a7;
          (_a7 = this._focusedItem) == null ? void 0 : _a7.focus();
          this._focusedItem = null;
        });
      }
    }
  ...
  _onIdleChange(idle, trigger) {
    ...
    if (idle && document.activeElement && ((_a6 = this.el) == null ? void 0 : _a6.contains(document.activeElement))) {
      this._focusedItem = document.activeElement;
      requestAnimationFrame(() => {
        var _a7;
        return (_a7 = this.el) == null ? void 0 : _a7.focus();
      });
    }
...
var MediaRequestContext = class {
  constructor() {
    __publicField(this, "_seeking", false);
    __publicField(this, "_looping", false);
    __publicField(this, "_replaying", false);
    __publicField(this, "_queue", new Queue());
  }
};
var MediaRequestManager = class extends ComponentController {
  constructor(instance, _stateMgr, _request, _media) {
    ...
    __publicField(this, "_fullscreen");
    __publicField(this, "_orientation");
    __publicField(this, "_store");
    __publicField(this, "_provider");
    __publicField(this, "_wasPIPActive", false);
  ...
  _handleRequest(event) {
    ...
    event.stopPropagation();
    {
      (_a6 = this._media.logger) == null ? void 0 : _a6.infoGroup(`📬 received \`${event.type}\``).labelledLog("Request", event).dispatch();
    }
  ...
  async _enterFullscreen(target = "prefer-media") {
    const provider = peek(this._provider);
    const adapter = target === "prefer-media" && this._fullscreen.supported || target === "media" ? this._fullscreen : provider == null ? void 0 : provider.fullscreen;
  ...
  _onFullscreenSupportChange() {
    var _a6, _b2;
    const { canLoad, canFullscreen: canFullscreen2 } = this._store, supported = this._fullscreen.supported || ((_b2 = (_a6 = this._provider()) == null ? void 0 : _a6.fullscreen) == null ? void 0 : _b2.supported) || false;
  ...
  _onPiPSupportChange() {
    var _a6, _b2;
    const { canLoad, canPictureInPicture } = this._store, supported = ((_b2 = (_a6 = this._provider()) == null ? void 0 : _a6.pictureInPicture) == null ? void 0 : _b2.supported) || false;
  ...
  ["media-audio-track-change-request"](event) {
    ...
    if (this._media.audioTracks.readonly) {
      {
        (_a6 = this._media.logger) == null ? void 0 : _a6.warnGroup(`[vidstack] attempted to change audio track but it is currently read-only`).labelledLog("Event", event).dispatch();
      }
      return;
    }
  ...
  ["media-live-edge-request"](event) {
    ...
    try {
      ...
      (_a6 = this._media.logger) == null ? void 0 : _a6.error("seek to live edge fail", e);
    }
  }
  ["media-loop-request"]() {
  ...
  async ["media-pause-request"](event) {
    ...
    try {
      ...
      (_a6 = this._media.logger) == null ? void 0 : _a6.error("pause-fail", e);
    }
  }
  ...
  ["media-quality-change-request"](event) {
    ...
    if (this._media.qualities.readonly) {
      {
        (_a6 = this._media.logger) == null ? void 0 : _a6.warnGroup(`[vidstack] attempted to change video quality but it is currently read-only`).labelledLog("Event", event).dispatch();
      }
      return;
    }
  ...
  ["media-text-track-change-request"](event) {
    ...
    if (track) {
      ...
      (_a6 = this._media.logger) == null ? void 0 : _a6.warnGroup("[vidstack] failed text track change request (invalid index)").labelledLog("Text Tracks", this._media.textTracks.toArray()).labelledLog("Index", index).labelledLog("Event", event).dispatch();
    }
  }
...
var MediaStateManager = class extends ComponentController {
  constructor(instance, _request, _media) {
    super(instance);
    __publicField(this, "_store");
    __publicField(this, "_trackedEvents", /* @__PURE__ */ new Map());
    __publicField(this, "_skipInitialSrcChange", true);
    __publicField(this, "_firingWaiting", false);
    __publicField(this, "_waitingTrigger");
    ...
    __publicField(this, "_fireWaiting", functionDebounce(() => {
  ...
  _handle(event) {
    ...
    (_a6 = this[event.type]) == null ? void 0 : _a6.call(this, event);
    {
  ...
  ["source-change"](event) {
    ...
    (_a6 = this.el) == null ? void 0 : _a6.setAttribute("aria-busy", "true");
    {
  ...
  ["can-play"](event) {
    var _a6, _b2;
    if (((_a6 = event.trigger) == null ? void 0 : _a6.type) !== "loadedmetadata") {
  ...
  ["seeked"](event) {
    ...
    if (this._request._seeking) {
      ...
      if (((_a6 = waitingEvent == null ? void 0 : waitingEvent.trigger) == null ? void 0 : _a6.type) !== "seeking") {
...
var TextTrack = class extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      import("./dev-ACY4TCBP.js").then(({ parseText, VTTCue, VTTRegion }) => {
        if (init.type === "json") {
  ...
  /* @internal */
  [(_a4 = TEXT_TRACK_READY_STATE, _b = TEXT_TRACK_CROSSORIGIN, _c = TEXT_TRACK_ON_MODE_CHANGE, _d = TEXT_TRACK_NATIVE, TEXT_TRACK_UPDATE_ACTIVE_CUES)](currentTime, trigger) {
  ...
  async _load() {
    ...
    try {
      const { parseResponse, VTTCue, VTTRegion } = await import("./dev-ACY4TCBP.js"), crossorigin = (_a6 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a6.call(this);
  ...
  _readyState() {
    ...
    if (!this.src || this.type !== "vtt") {
      const nativeTrack = (_a6 = this[TEXT_TRACK_NATIVE]) == null ? void 0 : _a6.track;
      if (nativeTrack)
...
var MediaRemoteControl = class {
  constructor(_logger) {
    ...
    __publicField(this, "_prevTrackIndex", -1);
  ...
  setTarget(target) {
    var _a6;
    this._target = target;
    (_a6 = this._logger) == null ? void 0 : _a6.setTarget(target);
  }
  /**
  ...
  _dispatchRequest(type, trigger, detail) {
    ...
    {
      (_a6 = this._logger) == null ? void 0 : _a6.infoGroup(`📨 dispatching \`${type}\``).labelledLog("Target", target).labelledLog("Player", this._player).labelledLog("Request Event", request).labelledLog("Trigger Event", trigger).dispatch();
    }
...
var ThumbnailsLoader = class extends ComponentController {
  ...
  _onLoadCues() {
    ...
    if (!src)
      return;
    import("./dev-ACY4TCBP.js").then(({ parseResponse }) => {
      parseResponse(
        fetch(src, {
...
var NativeTextRenderer = class {
  constructor() {
    ...
    __publicField(this, "_display", true);
    __publicField(this, "_video", null);
    __publicField(this, "_track", null);
    __publicField(this, "_tracks", /* @__PURE__ */ new Set());
  }
  canRender() {
    return true;
  }
  ...
  _attachTrack(track) {
    if (!this._video)
      return;
    const el = track[TEXT_TRACK_NATIVE] ?? (track[TEXT_TRACK_NATIVE] = this._createTrackElement(track));
  ...
  _copyCues(track, native) {
    var _a6;
    if (track.src && track.type === "vtt" || ((_a6 = native.cues) == null ? void 0 : _a6.length))
      return;
...
var TextRenderers = class {
  constructor(_media) {
    __publicField(this, "_video", null);
    __publicField(this, "_textTracks");
    __publicField(this, "_renderers", []);
    __publicField(this, "_nativeDisplay", false);
    __publicField(this, "_nativeRenderer", null);
    __publicField(this, "_customRenderer", null);
    this._media = _media;
...
var TextTrackList = class extends List {
  constructor() {
    ...
    __publicField(this, "_onTrackModeChangeBind", this._onTrackModeChange.bind(this));
  }
  get selected() {
  ...
  /* @internal */
  [(_a5 = TEXT_TRACK_CROSSORIGIN, TEXT_TRACK_CAN_LOAD)]() {
    if (this._canLoad)
      return;
    for (const track of this._items)
      track[TEXT_TRACK_CAN_LOAD]();
...
var SourceSelection = class {
  ...
  _onSourceChange() {
    ...
    const sources = $store.sources(), currentSource = peek($store.source), newSource = this._findNewSource(currentSource, sources), noMatch = ((_a6 = sources[0]) == null ? void 0 : _a6.src) && !newSource.src && !newSource.type;
...
Falling back to fetching source headers...`
  ...
  _notifyLoaderChange(currentLoader, newLoader) {
    ...
    newLoader && peek(() => {
      var _a6;
      return (_a6 = newLoader.preconnect) == null ? void 0 : _a6.call(newLoader, this._media);
    });
  ...
  _onPreconnect() {
    ...
    peek(() => {
      var _a6;
      return (_a6 = provider.preconnect) == null ? void 0 : _a6.call(provider, this._media);
    });
  }
  _onLoadSource() {
    var _a6;
    ...
    try {
      ...
      {
        (_a6 = this._media.logger) == null ? void 0 : _a6.infoGroup(`Failed to preconnect to source: ${source.src}`).labelledLog("Error", e).dispatch();
      }
    }
  }
};
...
var Tracks = class {
  constructor(_domTracks, _media) {
    __publicField(this, "_prevTracks", []);
...
var Outlet = class extends Component {
  constructor(instance) {
    super(instance);
    __publicField(this, "_media");
    __publicField(this, "_domSources", signal([]));
    __publicField(this, "_domTracks", signal([]));
    __publicField(this, "_loader", signal(null));
    this._media = useMedia();
  ...
  render() {
    ...
    onDispose(() => {
      var _a6;
      return (_a6 = currentProvider == null ? void 0 : currentProvider.destroy) == null ? void 0 : _a6.call(currentProvider);
    });
    return () => {
...
// node_modules/vidstack/dist/dev/media-ui.js
...
var FocusVisibleController = class extends ComponentController {
  constructor() {
    super(...arguments);
    __publicField(this, "_focused", signal(false));
  }
  onConnect(el) {
    effect2(() => {
      if (!$keyboard()) {
...
var ToggleButton = class extends Component {
  constructor(instance) {
    super(instance);
    __publicField(this, "_pressed", signal(false));
    __publicField(this, "_keyShortcut");
...
var PlayButton = class extends ToggleButton {
  constructor() {
    super(...arguments);
    __publicField(this, "_media");
    __publicField(this, "_keyShortcut", "togglePaused");
  }
  onAttach(el) {
    this._media = useMedia();
...
__publicField(PlayButton, "el", defineElement({
...
var CaptionButton = class extends ToggleButton {
  constructor() {
    super(...arguments);
    __publicField(this, "_media");
    __publicField(this, "_keyShortcut", "toggleCaptions");
  }
  onAttach(el) {
    this._media = useMedia();
    this._pressed = this._isPressed.bind(this);
...
__publicField(CaptionButton, "el", defineElement({
...
var FullscreenButton = class extends ToggleButton {
  constructor() {
    super(...arguments);
    __publicField(this, "_media");
    __publicField(this, "_keyShortcut", "toggleFullscreen");
  }
  onAttach(el) {
    this._media = useMedia();
    this._pressed = this._isPressed.bind(this);
...
__publicField(FullscreenButton, "el", defineElement({
...
var MuteButton = class extends ToggleButton {
  constructor() {
    super(...arguments);
    __publicField(this, "_media");
    __publicField(this, "_keyShortcut", "toggleMuted");
  }
  onAttach(el) {
    this._media = useMedia();
    this._pressed = this._isPressed.bind(this);
...
__publicField(MuteButton, "el", defineElement({
...
var PIPButton = class extends ToggleButton {
  constructor() {
    super(...arguments);
    __publicField(this, "_media");
    __publicField(this, "_keyShortcut", "togglePictureInPicture");
  }
  onAttach(el) {
    this._media = useMedia();
    this._pressed = this._isPressed.bind(this);
...
__publicField(SeekButton, "el", defineElement({
...
var SliderEventsController = class extends ComponentController {
  constructor(instance, _delegate, _media) {
    super(instance);
    __publicField(this, "_outlet", null);
    __publicField(this, "_touchX", null);
    __publicField(this, "_touchStartValue", null);
    __publicField(this, "_thumb", null);
    __publicField(this, "_trackFill", null);
    // -------------------------------------------------------------------------------------------
    // Keyboard Events
    // -------------------------------------------------------------------------------------------
    __publicField(this, "_lastDownKey");
    __publicField(this, "_onDocumentPointerMove", functionThrottle(
      (event) => {
  ...
  onConnect() {
    ...
    if (this._delegate._swipeGesture) {
      scopedRaf(() => {
        var _a6;
        const outlet = (_a6 = this._media.player) == null ? void 0 : _a6.querySelector("media-outlet");
        if (outlet) {
          this._outlet = outlet;
  ...
  _updatePointerValue(value, trigger) {
    ...
    if (dragging()) {
      ...
      if (this._trackFill && !((_a6 = this.el) == null ? void 0 : _a6.hasAttribute("data-chapters"))) {
...
var $$_templ$h = $$_create_template(`<!$><div part="track"></div>`);
var $$_templ_2$6 = $$_create_template(`<!$><div part="track track-fill"></div>`);
var $$_templ_3$1 = $$_create_template(`<!$><div part="track track-progress"></div>`);
var $$_templ_4 = $$_create_template(`<!$><div part="thumb-container"><!$><div part="thumb"></div></div>`);
var Slider = class extends Component {
  constructor(instance) {
    ...
    __publicField(this, "_orientation", "");
    __publicField(this, "_updateSliderVars", animationFrameThrottle(
      (fillPercent, pointerPercent) => {
        var _a6, _b2;
        (_a6 = this.el) == null ? void 0 : _a6.style.setProperty("--slider-fill-percent", fillPercent + "%");
    ...
    // Preview
    // -------------------------------------------------------------------------------------------
    __publicField(this, "_preview", null);
    __publicField(this, "_onPreviewResize", animationFrameThrottle(() => {
      if (!this._preview)
        return;
  ...
  _setupPreview() {
    ...
    Promise.resolve().then(function() {
      ...
      setupPreviewStyles2(this._preview, this._orientation);
    });
  }
  _watchPreview() {
...
var $$_templ$g = $$_create_template(`<!$><img part="img" loading="eager" decoding="async" aria-hidden="true" />`);
var Thumbnail = class extends Component {
  constructor(instance) {
    super(instance);
    __publicField(this, "_media");
    __publicField(this, "_img", null);
    __publicField(this, "_coords", null);
    __publicField(this, "_styleResets", []);
    __publicField(this, "_src", signal(""));
    __publicField(this, "_loaded", signal(false));
    __publicField(this, "_activeCue", signal(null));
    __publicField(this, "_requestResize", animationFrameThrottle(this._resize.bind(this)));
    this._media = useMedia();
  }
  onAttach() {
    this.setAttributes({
...
var $$_templ$f = $$_create_template(`<!$><media-thumbnail part="thumbnail" mk-d></media-thumbnail>`);
...
var $$_templ$e = $$_create_template(`<!$><video muted="" playsinline="" preload="auto" part="video" style="max-width: unset"></video>`);
var SliderVideo = class extends Component {
  constructor() {
    ...
    __publicField(this, "_slider");
    __publicField(this, "_video", null);
    __publicField(this, "_canPlay", signal(false));
    __publicField(this, "_error", signal(false));
...
var $$_templ$d = $$_create_template(`<!$><span><!$></span>`);
var SliderValue = class extends Component {
  ...
  _getText() {
    ...
    if (format() === "percent") {
      ...
      return ((_b2 = (_a6 = this._format).value) == null ? void 0 : _b2.call(_a6, value)) ?? value.toFixed(2);
    }
  }
  render() {
    return (() => {
...
var VolumeSlider = class extends Slider {
  constructor() {
    super(...arguments);
    __publicField(this, "_readonly", true);
    __publicField(this, "_throttleVolumeChange", functionThrottle(this._onVolumeChange.bind(this), 25));
  }
  onAttach(el) {
...
__publicField(VolumeSlider, "el", defineElement({
...
var ClassManager = class {
  constructor(el) {
    ...
    __publicField(this, "_classes", signal([]));
    __publicField(this, "_requestUpdate", animationFrameThrottle(this._update.bind(this)));
...
var $$_templ$c = $$_create_template(`<div part="chapters"></div>`);
var $$_templ_2$5 = $$_create_template(`<div part="chapter-container"><div part="chapter"><div part="track"></div><div part="track track-fill" style="width: 0%"></div><div part="track track-progress" style="width: 0%"></div></div></div>`);
var SliderChaptersRenderer = class {
  constructor(_media, _slider, _onChange) {
    __publicField(this, "_chapters", []);
    __publicField(this, "_refs", []);
    __publicField(this, "_activeChapterIndex", 0);
    __publicField(this, "_bufferedChapterIndex", 0);
    __publicField(this, "_updateBufferedPercent", animationFrameThrottle((bufferedPercent) => {
      let width;
    ...
    __publicField(this, "_bufferedPercent", computed(this._calcMediaBufferedPercent.bind(this)));
    this._media = _media;
...
var TimeSlider = class extends Slider {
  constructor(instance) {
    super(instance);
    __publicField(this, "_readonly", true);
    __publicField(this, "_swipeGesture", true);
    __publicField(this, "_dispatchSeeking");
    __publicField(this, "_track", signal(null));
    __publicField(this, "_chaptersRenderer");
    __publicField(this, "_classManager");
    __publicField(this, "_playingBeforeDragStart", false);
    // -------------------------------------------------------------------------------------------
    // Chapters
    // -------------------------------------------------------------------------------------------
    __publicField(this, "_chapterTitleEl", null);
    __publicField(this, "_chapterTitle", signal(""));
    provideContext(sliderValueFormatContext, {
  ...
  _hasChapters() {
    var _a6, _b2;
    const { duration } = this._media.$store;
    (_a6 = this._classManager) == null ? void 0 : _a6._requestUpdate();
    return ((_b2 = this._track()) == null ? void 0 : _b2.cues.length) && Number.isFinite(duration()) && duration() > 0;
  }
  onConnect(el) {
    super.onConnect(el);
  ...
  render() {
    ...
    return [$$_computed(() => {
      var _a6;
      return this._chaptersRenderer.render((_a6 = this._track()) == null ? void 0 : _a6.cues, chaptersClass);
    }), tracks];
  }
  ...
  _onTrackChange() {
    var _a6;
    this._track();
    this._chapterTitleEl = ((_a6 = this.el) == null ? void 0 : _a6.querySelector('[part="chapter-title"]')) ?? null;
...
__publicField(TimeSlider, "el", defineElement({
...
var MenuFocusController = class {
  ...
  _focusAt(index) {
    var _a6;
    this._index = index;
    (_a6 = this._elements[index]) == null ? void 0 : _a6.focus();
    this._scroll(index);
  }
  _findActiveIndex() {
...
var Menu = class extends Component {
  constructor(instance) {
    super(instance);
    __publicField(this, "_media");
    __publicField(this, "_menuId");
    __publicField(this, "_menuButtonId");
    __publicField(this, "_expanded", signal(false));
    __publicField(this, "_disabled", signal(false));
    __publicField(this, "_buttonDisabled", signal(false));
    __publicField(this, "_parentMenu");
    __publicField(this, "_submenus", /* @__PURE__ */ new Set());
    __publicField(this, "_menuButton", null);
    __publicField(this, "_menuItems", null);
    __publicField(this, "_menuObserver", null);
    __publicField(this, "_focus");
    __publicField(this, "_disableBind", this._disable.bind(this));
    __publicField(this, "_removeSubmenuBind", this._removeSubmenu.bind(this));
    __publicField(this, "_onSubmenuOpenBind", this._onSubmenuOpen.bind(this));
    __publicField(this, "_onSubmenuCloseBind", this._onSubmenuClose.bind(this));
    this._media = useMedia();
  ...
  onConnect(el) {
    ...
    (_a6 = this._parentMenu) == null ? void 0 : _a6._addSubmenu(el);
  ...
  _removePopupMenu() {
    var _a6, _b2;
    if (!this._menuItems || ((_a6 = this.el) == null ? void 0 : _a6.contains(this._menuItems)))
      return;
    const menu = (_b2 = this._menuItems) == null ? void 0 : _b2.parentElement;
  ...
  _watchBreakpoint() {
    ...
    if (popup && !fullscreen()) {
      if ((_b2 = (_a6 = this.el).contains) == null ? void 0 : _b2.call(_a6, this._menuItems)) {
  ...
  _onMenuButtonPress(event) {
    ...
    tick();
    if (isKeyboardEvent(event)) {
      (_a6 = this._menuItems) == null ? void 0 : _a6.focus();
    }
  ...
  _onChange(trigger) {
    ...
    if (expanded) {
      if (!this._parentMenu) {
        (_a6 = this._media.activeMenu) == null ? void 0 : _a6.close(trigger);
        this._media.activeMenu = this;
      }
      (_c2 = (_b2 = this._menuObserver) == null ? void 0 : _b2._onOpen) == null ? void 0 : _c2.call(_b2, trigger);
    } else {
      if (!this._parentMenu) {
        setTimeout(() => {
      ...
      (_e = (_d2 = this._menuObserver) == null ? void 0 : _d2._onClose) == null ? void 0 : _e.call(_d2, trigger);
    }
  ...
  _onResize() {
    ...
    if (((_a6 = children[0]) == null ? void 0 : _a6.localName) === "shadow-root") {
  ...
  close(trigger) {
    ...
    if (isKeyboardEvent(trigger)) {
      requestAnimationFrame(() => {
        var _a6;
        (_a6 = this._menuButton) == null ? void 0 : _a6.focus();
      });
    }
    this._onChange(trigger);
    this._changeIdleTracking(trigger);
...
var RadioGroup = class extends Component {
  constructor(instance) {
    super(instance);
    __publicField(this, "_group", /* @__PURE__ */ new Set());
    __publicField(this, "_value", signal(""));
    __publicField(this, "_onChangeBind", this._onChange.bind(this));
...
var $$_templ$b = $$_create_template(`<!$><div part="check"></div>`);
var Radio = class extends Component {
  constructor(instance) {
    super(instance);
    __publicField(this, "_checked", signal(false));
  ...
  _watchValue() {
    ...
    if (peek(this._checked)) {
      (_b2 = (_a6 = this._controller)._onCheck) == null ? void 0 : _b2.call(_a6, newValue);
    }
  }
  _onPress(event) {
    var _a6, _b2;
    ...
    (_b2 = (_a6 = this._controller)._onCheck) == null ? void 0 : _b2.call(_a6, peek(this.$props.value), event);
  }
...
var $$_templ$a = $$_create_template(`<!$><media-radio-group mk-d><!$></media-radio-group>`);
var $$_templ_2$4 = $$_create_template(`<!$><media-radio mk-d><!$></media-radio>`);
...
var $$_templ$9 = $$_create_template(`<!$><media-thumbnail part="thumbnail" mk-d></media-thumbnail>`);
var $$_templ_2$3 = $$_create_template(`<!$><div part="content"><div part="title"><!$></div><div part="start-time"><!$></div><div part="duration"><!$></div></div>`);
var ChaptersMenuItems = class extends MenuItems {
  constructor(instance) {
    super(instance);
    __publicField(this, "_media");
    __publicField(this, "_index", signal(0));
    __publicField(this, "_track", signal(null));
    this._media = useMedia();
  }
  onAttach(el) {
  ...
  _onChange(event) {
    ...
    if (this._isDisabled() || !event.trigger)
      return;
    const index = +event.target.value, cues = (_a6 = this._track()) == null ? void 0 : _a6.cues;
...
var $$_templ$8 = $$_create_template(`<!$><span part="label"><!$></span>`);
...
var $$_templ$7 = $$_create_template(`<!$><span slot="label"><!$></span>`);
var $$_templ_2$2 = $$_create_template(`<!$><div slot="hint"></div>`);
...
var $$_templ$6 = $$_create_template(`<!$><span part="label"><!$></span>`);
var $$_templ_2$1 = $$_templ$6;
...
var $$_templ$5 = $$_create_template(`<!$><span part="label"><!$></span>`);
...
var $$_templ$4 = $$_create_template(`<!$><span><!$></span>`);
var $$_templ_23 = $$_create_template(`<!$><span part="label"><!$></span>`);
var $$_templ_3 = $$_create_template(`<!$><span part="info"><!$></span>`);
var QualityMenuItems = class extends MenuItems {
  constructor(instance) {
    super(instance);
    __publicField(this, "_media");
    __publicField(this, "_sortedQualities", computed(() => {
    ...
    return [
      ...
      ...this._sortedQualities().map((quality) => {
        ...
        return {
          ...
          content: () => [
            (() => {
              const [$$_root, $$_walker] = $$_create_walker($$_templ_23), $$_expr = $$_walker.nextNode();
...
var Gesture = class extends Component {
  constructor() {
    ...
    __publicField(this, "_media");
    __publicField(this, "_outlet", null);
    __publicField(this, "_presses", 0);
    __publicField(this, "_pressTimerId", -1);
  }
  onAttach() {
  ...
  _acceptEvent(event) {
    ...
    event.preventDefault();
    const isDblEvent = (_a6 = peek(this.$props.event)) == null ? void 0 : _a6.startsWith("dbl");
    if (!isDblEvent) {
      if (this._presses === 0) {
        setTimeout(() => {
          if (this._presses === 1)
  ...
  _isTopLayer() {
    ...
    return ((_a6 = Array.from(gestures).sort(
      (a, b) => +getComputedStyle(b).zIndex - +getComputedStyle(a).zIndex
    )[0]) == null ? void 0 : _a6.component) === this;
  }
...
var $$_templ$3 = $$_create_template(`<!$><svg part="icon" fill="none" viewBox="0 0 120 120" aria-hidden="true"><circle part="track" cx="60" cy="60" r="54" stroke="currentColor"></circle><circle part="track-fill" cx="60" cy="60" r="54" stroke="currentColor" pathLength="100"></circle></svg>`);
...
var CaptionsTextRenderer = class {
  constructor(_renderer) {
    ...
    __publicField(this, "_track", null);
    __publicField(this, "_disposal", createDisposalBin());
...
var Captions = class extends Component {
  constructor() {
    ...
    __publicField(this, "_textRenderer");
  }
  onAttach() {
    this._media = useMedia();
    this.setAttributes({
  ...
  onDisconnect() {
    ...
    (_a6 = this._renderer) == null ? void 0 : _a6.destroy();
  }
  _isHidden() {
    const { textTrack } = this._media.$store, track = textTrack();
    return !track || !isTrackCaptionKind(track);
...
var $$_templ$2 = $$_create_template(`<!$><div part="container"><div part="text">LIVE</div></div>`);
...
var $$_templ$1 = $$_create_template(`<!$><img part="img" />`);
var Poster = class extends Component {
  constructor() {
    super(...arguments);
    __publicField(this, "_media");
    __publicField(this, "_imgLoading", signal(true));
    __publicField(this, "_imgError", signal(false));
    __publicField(this, "_imgSrc");
    __publicField(this, "_imgAlt");
  }
  onAttach(el) {
    this._media = useMedia();
...
var $$_templ4 = $$_create_template(`<!$><span><!$></span>`);
var Time = class extends Component {
  ...
  render() {
    return (() => {
      const [$$_root, $$_walker] = $$_create_walker($$_templ4), $$_expr = $$_walker.nextNode();
...
maverick.js/dist/dev/chunks/chunk-FIEGXSET.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HZMNTWTL.js.map
